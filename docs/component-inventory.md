...
| `first-run-tips.ts` | The seven tips shown while a new user's first digest generates. **Not a component — a maintained content surface**: update it whenever a user-facing feature is added, removed or renamed (rule is in CLAUDE.md too) | ✅ new |
