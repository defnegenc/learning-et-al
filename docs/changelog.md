...
| 2026-07-23 | Removed third-source filler: all 2–3 papers are now chosen together by the same relevance/complementarity selector; three is a ceiling rather than a quota. Rescue searches stop at the 2-source minimum, and the final reranker drops any extra source below direct relevance 3/3 or insight 2/3 instead of swapping in an unscored replacement. News can rescue a one-source digest but is never appended as slot-three filler. | Done |
